...
btn.addEventListener('click',async (evento) =>{
    ...
    fetch(`https://api.hgbrasil.com/weather?format=json-cors&key=3ce1acab&city_name=${cidade}&array_limit=7&fields=only_results,city_name,city,date,temp,condition_slug,description,forecast,weekday,condition,max,min`)
